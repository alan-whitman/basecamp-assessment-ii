...
message["text"] = "derp derp";

// #4 Create an object called 'adjustCount' and create two methods. One called 'upVote' and one called 'downVote'. upVote should take in a number and add one to it and downVote should take in a number and minus one from it.

var adjustCount = {
  upVote: function (someNumber)  {
    return someNumber + 1;
  },
  downVote: function (someNumber)  {
    return someNumber - 1;
  }
}
...
var myFriends = ["bob", "david", "scott", "paul"];

// #6 Add a fifth friends name to the end of your myFriends array

myFriends.push("lauren");
...
//DON'T TOUCH THE CODE ABOVE
function evensOnly() {
  return myNumbers.filter((v, i, a) => {return !(v % 2)});
}
...
var trueFriends = peopleIknow.filter((v, i, a) => {if (a[i].friend === true) return true});
...
function indexFinder(someArray)  {
  var indexArray = [];
